...
export function Header() {
  ...
  useEffect(() => {
    ...
    const eventOptions: AddEventListenerOptions & EventListenerOptions = {
      passive: true,
    };

    updateStyles();
    window.addEventListener('scroll', updateStyles, eventOptions);
    window.addEventListener('resize', updateStyles);

    return () => {
      window.removeEventListener('scroll', updateStyles, eventOptions);
